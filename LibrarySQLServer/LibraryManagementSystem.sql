CREATE DATABASE LibraryManagerPractice
...
CREATE TABLE Book_Authors(
		Book_id INT NOT NULL IDENTITY (1,1) CONSTRAINT fk_book_id FOREIGN KEY REFERENCES dbo.Book(Book_id),
		Author_Name VARCHAR(50) NOT NULL
	);

CREATE TABLE Book_Copies (
		Book_id INT NOT NULL IDENTITY (1,1) CONSTRAINT fk_book_id_copies FOREIGN KEY REFERENCES dbo.Book(Book_id),
		Branch_id INT NOT NULL,
		No_of_Copies INT NOT NULL
	);

CREATE TABLE Book_Loans (
		Book_id INT NOT NULL CONSTRAINT fk_book_id_loans FOREIGN KEY REFERENCES dbo.Book(Book_id),
	...
	INSERT INTO dbo.Book 
		...
		('Fake Jones', '132 Mockingbird Way', '445-1212')
		;
		...
		VALUES
			...
			(1, 1, 8, '7/14/17', '7/20/17'),
			(2, 3, 3, '7/15/17', '7/21/17'),
			(3, 2, 6, '7/16/17', '7/22/17'),
			(4, 4, 6, '7/17/17', '7/23/17'),
			(5, 4, 2, '7/18/17', '7/24/17'),
			(6, 2, 4, '7/19/17', '7/25/17'),
			(7, 1, 1, '7/20/17', '7/26/17'),
			(7, 2, 1, '7/20/17','7/26/17'),
			(8, 3, 2, '7/21/17', '7/27/17'),
			(9, 2, 6, '7/22/17', '7/28/17'),
			(10, 4, 4, '7/23/17', '7/29/17'),
			(11, 1, 3, '7/24/17', '7/30/17'),
			(12, 2, 5, '7/25/17', '7/31/17'),
			(13, 1, 2, '7/26/17', '8/1/17'),
			(14, 1, 7, '7/27/17', '8/2/17'),
			(15, 3, 6, '7/27/17', '8/2/17'),
			(16, 4, 8, '7/28/17', '8/3/17'),
			(17, 1, 3, '7/29/17', '8/4/17'),
			(18, 1, 5, '7/30/17', '8/5/17'),
			(19, 1, 7, '7/31/17', '8/6/17'),
			(20, 1, 6, '7/31/17', '8/6/17'),
			(1, 1, 8, '7/31/17', '8/6/17'),
			(2, 3, 3, '8/1/17', '8/7/17'),
			(3, 2, 6, '8/1/17', '8/7/17'),
			(4, 4, 6, '8/2/17', '8/8/17'),
			(5, 4, 2, '8/3/17', '8/9/17'),
			(6, 2, 4, '8/3/17', '8/9/17'),
			(7, 1, 1, '8/4/17', '8/10/17'),
			(8, 3, 2, '8/5/17', '8/11/17'),
			(9, 2, 6, '8/6/17', '8/12/17'),
			(10, 4, 4, '8/6/17', '8/12/17')
			;
